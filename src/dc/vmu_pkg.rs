...
#[link(name = "kallisti")]
unsafe extern "C" {
    pub fn vmu_pkg_build(src: *mut vmu_pkg_t, dst: *mut *mut u8, dst_size: *mut c_int) -> c_int;
    pub fn vmu_pkg_parse(data: *mut u8, data_size: c_size_t, pkg: *mut vmu_pkg_t) -> c_int;
